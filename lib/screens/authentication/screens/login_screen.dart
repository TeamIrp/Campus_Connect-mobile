...
class _LoginScreenState extends State<LoginScreen> {
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      context.goNamed(
                                          RouteConstant.FORGOT_PASSWORD_SCREEN);
                                    },
                                    child: Text(
                                      "Forgot Password",
                                      style: TextStyle(
                                        ...
                                        // Adds underline
                                        decorationColor: AppColorConstant.blue,
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    if (_emailController.text.isEmpty &&
                                      ...
                                      getLogin(context, _emailController.text,
                                          _passwordController.text);
                                    }
                                  },
  ...
  Future<void> getLogin(
    ...
    if (loginProvider.loginResponse?.statusCode == 200 &&
      ...
      SharedPreferenceHelper.saveData(SharedPreferenceConstant.USER_ID,
          loginProvider.loginResponse?.data?.userDetails?.id.toString());
      SharedPreferenceHelper.saveData(SharedPreferenceConstant.TOKEN,
          loginProvider.loginResponse?.data?.token.toString());
    }
  }
}
