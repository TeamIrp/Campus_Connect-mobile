// import 'dart:io';
// import 'package:campus_connect/screens/my_profile/screens/your_profile/my_profile_step_two_screen.dart';
// import 'package:campus_connect/screens/my_profile/widgets/profile_appbar.dart';
...
//               "City",
//               ["Paris", "London", "Berlin"],
//               value: ["Paris", "London", "Berlin"].contains(_selectedCity)
//                   ? _selectedCity
//                   : null,
...
//               value: ["Paris", "London", "Berlin"].contains(_selectedRegion)
//                   ? _selectedRegion
//                   : null,
...
class MyProfileTabScreenState extends State<MyProfileTabScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: selectedSection == ProfileSection.main
          ? PreferredSize(
